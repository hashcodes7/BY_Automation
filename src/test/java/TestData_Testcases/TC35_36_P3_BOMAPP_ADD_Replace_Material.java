...
public class TC35_36_P3_BOMAPP_ADD_Replace_Material extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC35_36_P3_BOMAPP_ADD_Replace_Material");
		}
	}

	@Test(priority = 0, dataProvider = "TC35_36_P3_BOMAPP_ADD_Replace_Material", dataProviderClass = DataProviders.class)
	public void P3_TC35_36_BOMAPP_ADD_Replace_Material(String TestType, String username, String password, String season,
			String PC9Code, String materialType, String component, String componentLocation, String remarks,
			String quantity, String newMaterial, String replaceMaterial) throws Exception {
		if (CloseBrowser) {
			test = extent.createTest(":::TC35_36_P3_BOMAPP_ADD_Replace_Material:::");
		}
		CloseBrowser = false;
