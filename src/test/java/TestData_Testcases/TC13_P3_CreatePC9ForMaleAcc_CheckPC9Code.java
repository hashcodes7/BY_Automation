...
public class TC13_P3_CreatePC9ForMaleAcc_CheckPC9Code extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC13_TD_CreateColorwayCodeM for type Levis Mens accessories");
		}
	}

	@Test(priority = 0, dataProvider = "TC13_P3_CreatePC9ForMaleAcc_CheckPC9Code", dataProviderClass = DataProviders.class)
	public void P0_TC_Product_004_Verify__Create_PC9_for_type_Levis_MensBottoms(String TestType, String season,
			...
			String linesheetview) throws Exception {
		if (CloseBrowser) {
			test = extent.createTest(":::TC13_TD_CreateColorwayCodeM for type Levis Mens accessories:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_170");
			...
			if (!PC9Code.isEmpty() && !PC9Code.equals("0")) {
				...
				addScreenShot("Colorway Code not displayed", test, Capture);
			}
