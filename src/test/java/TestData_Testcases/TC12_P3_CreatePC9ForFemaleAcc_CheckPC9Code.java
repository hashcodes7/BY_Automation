...
public class TC12_P3_CreatePC9ForFemaleAcc_CheckPC9Code extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC12_TD_CreateColorwayCodeF for type Levis Womens accessories");
		}
	}
	...
	public void P0_TC_Product_004_Verify__Create_PC9_for_type_Levis_MensBottoms(String TestType,String season,String product,String colormenu, 
		...
		if (CloseBrowser) {
			test = extent.createTest(":::TC12_TD_CreateColorwayCodeF for type Levis Womeens accessories:::");
		}
		CloseBrowser = false;
