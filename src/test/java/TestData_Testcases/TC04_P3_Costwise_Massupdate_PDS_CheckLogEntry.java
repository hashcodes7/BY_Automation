...
public class TC04_P3_Costwise_Massupdate_PDS_CheckLogEntry extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport(" TC04_P3_Costwise_Massupdate_PDS_CheckLogEntry");
		}
	...
	@Test(priority = 0,dataProvider = "TC04_P3_Costwise_Massupdate_PDS_CheckLogEntry", dataProviderClass = DataProviders.class)
	public void P3_TC04_MassUpdateLinesheet_PDS_logEntry_check(String TestType,String season,String filterdata,String linesheetview,
			String targetvolume,String globalmsrp,String createddate,String LogEntryObject,String event) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC04_P3_Costwise_Massupdate_PDS_CheckLogEntry:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This scenario covers 4 testcases(TC_05 to TC_08)");
...
//				addScreenShot("Records updated in linesheet is matching with the LogEntry records ", test, Capture);
//			}
