...
public class TC03_P3_CreateColorway_CheckLogEntry extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport(" TC03_P3_CreateColorway_CheckLogEntry");
		}
	}

	@Test(priority = 0,dataProvider = "TC03_P3_CreateColorway_CheckLogEntry", dataProviderClass = DataProviders.class)
	public void P3_TC_CreateColorway_logEntry_check(String TestType,String season,String product,String colormenu, 
			...
			String destroysampleInd,String collectionType,String capsule,String sizeGridCode,String currentPlannedLifecycle,String primaryfabric,String LogEntryObject,String event) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC03_P3_CreateColorway_CheckLogEntry:::");
		}
		CloseBrowser = false;
