...
public class TC02_P1_UpdateRigidIndicator_AfterSetupLSE extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC02_P1_UpdateRigidIndicator_AfterSetupLSE");
		}
	}

	@Test(priority = 0,dataProvider = "TC02_P1_UpdateRigidIndicator_AfterSetupLSE", dataProviderClass = DataProviders.class)
	public void P1_TC02_Verifyrigidindicator_updatePC9(String TestType,String season,String colorway,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC02_P1_UpdateRigidIndicator_AfterSetupLSE:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_63 to TC_66");
