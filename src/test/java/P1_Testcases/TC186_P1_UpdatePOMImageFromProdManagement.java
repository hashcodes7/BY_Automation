...
//			String measurementSet = "001 : test_auto_21";
			...
			addScreenShot("Clicked on New POM Images", test, Capture);
...
//			String imagePath = "C:\\Users\\2240786\\Downloads\\levis_logo.jpg";
			...
			addScreenShot("Image selected: " + imagePath, test, Capture);
			...
			if (isImageUpdated) {
				...
				addScreenShot("Image successfully updated", test, Capture);
			} else {
				test.log(Status.FAIL, "Image update failed. Verification failed.");
				addScreenShot("Image update failed", test, Capture);
			}
