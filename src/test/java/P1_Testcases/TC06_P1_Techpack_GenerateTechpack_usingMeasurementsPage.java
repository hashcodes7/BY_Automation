...
public class TC06_P1_Techpack_GenerateTechpack_usingMeasurementsPage extends WMS_TestBase{
	...
	public void P1_TC06_Techpack_GenerateTechpack_usingMeasurementsPage(String TestType,String season,String linesheetview,String filterproduct
		...
		try {
			...
			addScreenShot("Navigated to specifications techpack page  ", test, Capture);
			...
			addScreenShot("Validations successful for specification components  ", test, Capture);
			...
			addScreenShot("Techpack generated successfully and the file is downloaded  ", test, Capture);
			...
			addScreenShot("Validation successful and the file is downloaded   ", test, Capture);
