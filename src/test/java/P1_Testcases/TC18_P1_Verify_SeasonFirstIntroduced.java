...
public class TC18_P1_Verify_SeasonFirstIntroduced extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC18_P1 Verify Season First introduced Value");
		}
	}

	@Test(priority = 0,dataProvider = "TC18_P1_Verify_SeasonFirstIntroduced", dataProviderClass = DataProviders.class)
	public void P1_TC_Product_017_VerifyProfitCenterUS(String TestType,String season,String colorway,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC18_P1 Verify Season First introduced Value:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This testcase covers TC_28");
			...
			WaitforPage(5000);
			Colorwaypage.Validate_SeasonFirstIntroduced(test);
