...
//			String supplier = "3M INDUSTRIAL ADHESIVE & TAPES 603112 US";
			...
			if (isStagingRowIdUpdated) {
			    ...
			    addScreenShot("Material supplier staging row id is updated on the Material Supplier Details Page", test, Capture);
			} else {
			    ...
			    addScreenShot("Material supplier staging row id is not updated on the Material Supplier Details Page in PDS.", test, Capture);
			}
