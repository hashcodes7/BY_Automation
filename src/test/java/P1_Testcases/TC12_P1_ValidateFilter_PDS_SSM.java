...
public class TC12_P1_ValidateFilter_PDS_SSM extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC12_P1_ValidateFilter_PDS_SSM");
		}
	}
	@Test(priority = 0, dataProvider = "TC12_P1_ValidateFilter_PDS_SSM", dataProviderClass = DataProviders.class)
	public void P0_TC_12_ValidateLinesheet_PDS_SSM_Filter(String TestType,String season,String filterValue,String expectedAttributes
			,String productname,String colorwayname,String colorwaycode,String productcode,String linesheetview,String merchant,String PDS,String vendorId) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC12_P1_ValidateFilter_PDS_SSM :::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_119 to TC_122");
			...
			LineSheetEditPage.Enter_PDSSSM_FilterValues(productname,colorwayname,vendorId,colorwaycode,productcode,merchant,PDS,test);
