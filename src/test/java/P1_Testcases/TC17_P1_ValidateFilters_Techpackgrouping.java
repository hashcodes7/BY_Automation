...
public class TC17_P1_ValidateFilters_Techpackgrouping extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC17_P1_ValidateFilters_Techpackgrouping");
		}
	}
	@Test(priority = 0, dataProvider = "TC17_P1_ValidateFilters_Techpackgrouping", dataProviderClass = DataProviders.class)
	public void P1_TC_17_ValidateLinesheet_TechPack_Filter(String TestType,String season,String filterValue,String expectedAttributes,String productname,String colorwayname,
			String vendorId,String colorwaycode,String productcode,String available,String PDS,String garmentdeveloper,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC17_P1_ValidateFilters_Techpackgrouping:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_133 to TC_136");
			...
			LineSheetEditPage.Enter_TechpackgroupingFilter_values(productname,colorwayname,vendorId,colorwaycode,productcode,available,PDS,garmentdeveloper,test);
