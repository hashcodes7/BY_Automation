...
public class TC37_P1_Verify_DestroySample_UpdatePC9 extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC37_P1 Verify Destroy sample Indicator Value for Update PC9");
		}
	}

	@Test(priority = 0,dataProvider = "TC37_P1_Verify_DestroySample_UpdatePC9", dataProviderClass = DataProviders.class)
	public void P1_TC_Product_037_VerifySampleDestroyIndicator_Value(String TestType,String season,String colorway,String linesheetview
			,String productsegLSUSvalue,String productsegLSEvalue) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC37_P1 Verify Destroy sample Indicator Value for Update PC9:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This testcase covers TC_41");
			...
			WaitforPage(5000);
			Colorwaypage.Validate_DestroySampleIndicator(test);
