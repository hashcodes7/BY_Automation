...
public class TC195_P1_UpdatePC9_paletteColor extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC195_P1_UpdatePC9_paletteColor");
		}
	}

	@Test(priority = 0,dataProvider = "TC195_P1_UpdatePC9_paletteColor", dataProviderClass = DataProviders.class)
	public void P1_TC25_VerifyLookdetails_InCreatePC9(String TestType,String season,String colorway,String palettecolorname,String productsegLSUSvalue,
			String productsegLSEvalue,String classification,String producttype,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC195_P1_UpdatePC9_paletteColor:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_61");
