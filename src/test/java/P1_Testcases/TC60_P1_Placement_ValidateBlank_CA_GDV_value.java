...
public class TC60_P1_Placement_ValidateBlank_CA_GDV_value extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC60_P1_Placement_ValidateBlank_CA_GDV_value");
		}
	}

	@Test(priority = 0,dataProvider = "TC60_P1_Placement_ValidateBlank_CA_GDV_value", dataProviderClass = DataProviders.class)
	public void P1_TC_60_Placement_Blank_CA_GDV_value(String TestType,String uploadFilepath,String resultFilepath,String filetype,String season
			,String colorway,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC60_P1_Placement_ValidateBlank_CA_GDV_value:::");
		}
		CloseBrowser = false;
		...
		try {
			...
			test.log(Status.INFO, "This Testcase covers TC_211");
			...
			if(str[0].equalsIgnoreCase("Error")) {
				...
				customLoadersPage.Validate_CA_GDV_linesheet(colorway,test);
				test.log(Status.PASS, "Validation successful for CA_GDV value");
				System.out.println("Validation successful for CA_GDV value");
				addScreenShot("Validation successful for CA_GDV value", test, Capture);
