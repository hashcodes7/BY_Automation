...
public class TC09_P1_CustomLoaders_MaterialPrice extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC09_P1_CustomLoaders_MaterialPrice");
		}
	}

	@Test(priority = 0,dataProvider = "TC09_P1_CustomLoaders_MaterialPrice", dataProviderClass = DataProviders.class)
	public void P0_TC_009_Verify_CustomLoader_for_MaterialPrice(String TestType,String uploadFilepath,String resultFilepath,String filetype) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC09_P1_CustomLoaders_MaterialPrice:::");
		}
		CloseBrowser = false;
		...
		try {
			...
			test.log(Status.INFO, "This Testcase covers TC_85 and TC_86");
			...
			String result=customLoadersPage.ValidateMaterialPriceLoaderResult(resultFilepath);
