...
public class TC62_P1_Placement_ValidateBlank_MALA_GDV_Value extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC62_P1_Placement_ValidateBlank_MALA_GDV_Value");
		}
	}

	@Test(priority = 0,dataProvider = "TC62_P1_Placement_ValidateBlank_MALA_GDV_Value", dataProviderClass = DataProviders.class)
	public void P1_TC_62_Placement_Blank_MALA_GDV_value(String TestType,String uploadFilepath,String resultFilepath,String filetype,String season
			,String colorway,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC62_P1_Placement_ValidateBlank_MALA_GDV_Value:::");
		}
		CloseBrowser = false;
		...
		try {
			...
			test.log(Status.INFO, "This Testcase covers TC_212 and TC_213");
			...
			if(str[0].equalsIgnoreCase("Error")) {
				...
				customLoadersPage.Validate_MALA_GDV_linesheet(colorway,test);
				test.log(Status.PASS, "Validation successful for MALA_GDV value");
				System.out.println("Validation successful for MALA_GDV value");
				addSrceenShot("Validation successful for MALA_GDV value", test, Capture);
