...
public class TC17_P1_VerifyProfitCenter_US extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC17_P1 Verify Profit Center [US] Value");
		}
	}

	@Test(priority = 0,dataProvider = "TC17_P1_VerifyProfitCenter_US", dataProviderClass = DataProviders.class)
	public void P1_TC_Product_017_VerifyProfitCenterUS(String TestType,String season,String colorway,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC17_P1 Verify Profit Center [US] Value:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This testcase covers TC_27");
			...
			WaitforPage(5000);
			Colorwaypage.ValidateProfitCenter_US(test);
