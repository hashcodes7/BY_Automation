...
public class TC30_P1_VerifyLookDetails_UpdatePC9 extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC30_P1 Verify Look Details for PC9 Update" );
		}
	}

	@Test(priority = 0,dataProvider = "TC30_P1_VerifyLookDetails_UpdatePC9", dataProviderClass = DataProviders.class)
	public void P1_TC_Product_030_VerifyPC9Lookdetails(String TestType,String season,String colorway,String colormenu, 
			String colorsubmenu ,String filtercolor,String productsegLSUSvalue,String productsegLSEvalue,String linesheetview,
			String hubofferedto,String secondseason,String secondcolorway) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC30_P1 Verify Look Details for PC9 Update:::");
		}
		CloseBrowser = false;
