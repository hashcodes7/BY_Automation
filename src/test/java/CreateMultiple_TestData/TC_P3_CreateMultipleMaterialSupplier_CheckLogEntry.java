...
public class TC_P3_CreateMultipleMaterialSupplier_CheckLogEntry extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			initializePages();
			setReport("TC_P3_CreateMultipleMaterialSupplier_CheckLogEntry");
		}
	}
	...
	@Test(priority = 0, dataProvider = "Multiple_CreateMaterialSupplier_CheckLogEntry", dataProviderClass = DataProviders.class)
	public void P3_TC02_CreateMaterialSupplier_CheckLogEntry(String[][] testData)
			throws Exception {
		for (int i = 0; i < testData.length; i++) {
	        String[] data = testData[i];
	        String TestType = data[0];
	        String materialType = data[1];
	        String materialName = data[2];
	        String supplier = data[3];
	        String LogEntryObject = data[4];
	        String event = data[5];

			if (CloseBrowser) {
				test = extent.createTest(":::TC_P3_CreateMultipleMaterialSupplier_CheckLogEntry:::");
			}
