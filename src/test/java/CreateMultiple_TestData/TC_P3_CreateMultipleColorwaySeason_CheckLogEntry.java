...
public class TC_P3_CreateMultipleColorwaySeason_CheckLogEntry extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport(" TC_P3_CreateMultipleColorwaySeason_CheckLogEntry");
		}
	}

	@Test(priority = 0,dataProvider = "TC_P3_CreateMutipleColorwaySeason_CheckLogEntry", dataProviderClass = DataProviders.class)
...
//				String TestType = data[0];
		...
		if (CloseBrowser) {
			test = extent.createTest(":::TC_P3_CreateMultipleColorwaySeason_CheckLogEntry:::");
		}
		CloseBrowser = false;
