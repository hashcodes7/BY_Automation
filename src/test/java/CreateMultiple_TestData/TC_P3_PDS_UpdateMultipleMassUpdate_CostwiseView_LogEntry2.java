...
public class TC_P3_PDS_UpdateMultipleMassUpdate_CostwiseView_LogEntry2 extends WMS_TestBase {
	WebDriver driver;
...
//					String TestType = data[0];
		...
		try {
			...
			test.log(Status.INFO, "login to flex PLM application successfully and teh URL is : "+PDS_URL);
