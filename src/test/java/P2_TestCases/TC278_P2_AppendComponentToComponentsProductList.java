...
public class TC278_P2_AppendComponentToComponentsProductList extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC278_P2_Verify Append component to the Components-Product list");
		}
	}

	@Test(priority = 0, dataProvider = "TC278_P2_AppendComponentToComponentsProductList", dataProviderClass = DataProviders.class)
	public void P2_TC278_AppendComponentToComponentsProductList(String TestType, String season, String viewType,
			String colorWayName, String NewComponent) throws Exception {

		if (CloseBrowser) {
			test = extent.createTest(":::TC278_P2_Verify Append component to the Components-Product list:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This test case covers P2 Specification module from 278 to 281");
