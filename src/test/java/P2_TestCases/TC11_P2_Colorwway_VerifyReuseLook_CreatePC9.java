...
public class TC11_P2_Colorwway_VerifyReuseLook_CreatePC9 extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC11_P2_Colorwway_VerifyReuseLook_CreatePC9");
		}
	}

	@Test(priority = 0,dataProvider = "TC11_P2_Colorwway_VerifyReuseLook_CreatePC9", dataProviderClass = DataProviders.class)
	public void P2_TC_Product_11_Verify_Reuse_LookColor(String TestType,String season,String colorway,String colormenu, 
			String colorsubmenu,String filtercolor,String productsegLSUSvalue,String productsegLSEvalue,String classification,String producttype,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC11_P2_Colorwway_VerifyReuseLook_CreatePC9:::");
		}
		CloseBrowser = false;
