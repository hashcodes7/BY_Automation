...
public class TC18_P2_Placement_IncorrectMillCode extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC18_P2 Verify Error message for incorrect Fabric Mill Code in placement file");
		}
	}

	@Test(priority = 0,dataProvider = "TC18_P2_Placement_IncorrectMillCode", dataProviderClass = DataProviders.class)
	public void P0_TC_02_Placement_BlankSeasonCode(String TestType,String uploadFilepath,String resultFilepath,String filetype) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC18_P2 Verify Error message for incorrect Fabric Mill Code in placement file:::");
		}
		CloseBrowser = false;
		...
		try {
			...
			if(str[0].equalsIgnoreCase("Error")) {
				...
				if(str[1].equals("Mill SAP Code does not exist")) {
