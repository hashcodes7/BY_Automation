...
//			String specificationName = "S1 2025 - 0WPTE - 12th Aug PC9 - 5159";
			...
			addScreenShot("Clicked on Generate Techpack from the Specification Actions menu", test, Capture);

			boolean isDisplayed = vendorPage.verifyTechpackgenerationPage();
			if (isDisplayed) {
				test.log(Status.PASS, "Techpackgeneration page is displayed.");
				addScreenShot("Techpackgeneration page is displayed", test, Capture);
			} else {
				test.log(Status.FAIL, "Techpackgeneration page is not displayed.");
				addScreenShot("Techpackgeneration page is not displayed", test, Capture);
			}
