...
public class TC31_P2_Colorway_VerifyReuseLook_UpdatePC9 extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC31_P2_Colorway_VerifyReuseLook_UpdatePC9" );
		}
	}

	@Test(priority = 0,dataProvider = "TC31_P2_Colorway_VerifyReuseLook_UpdatePC9", dataProviderClass = DataProviders.class)
	public void P2_TC_Product_031_VerifyPC9Lookdetails(String TestType,String season,String colorway,String colormenu, 
			String colorsubmenu ,String filtercolor,String productsegLSUSvalue,String productsegLSEvalue,String linesheetview) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC31_P2_Colorway_VerifyReuseLook_UpdatePC9:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This testcase covers TC_31 to TC_33");
...
//          if colorsubmenu element is not there just keep blank string ----------------------			
			...
			System.out.println("Validation completed for update colorway by reusing Look color");
			test.log(Status.PASS, "Validation completed for update colorway by reusing Look color");
			addSrceenShot("Validation completed for update colorway by reusing Look color", test, Capture);
