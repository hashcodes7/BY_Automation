...
public class TC05_P0_TechPack_DownloadBOMTechpack extends WMS_TestBase {
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC05_P0 Download BOM file from Line sheet View");
		}
	}

	@Test( priority = 0, dataProvider = "TC05_P0_TechPack_DownloadBOMTechpack", dataProviderClass = DataProviders.class)
	public void P0_TC01_TechPack_PDView(String TestType,String season,String linesheetview,String sourcename) throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC05_P0 Download BOM file from Line sheet View:::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This testcase covers TC_265");
...
//			Thread.sleep(5000);
			...
			Techpackpages.Download_ColorwayBOM_File(test);
