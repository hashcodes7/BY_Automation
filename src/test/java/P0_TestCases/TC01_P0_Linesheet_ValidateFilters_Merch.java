...
public class TC01_P0_Linesheet_ValidateFilters_Merch extends WMS_TestBase {
	...
	public void setUp() throws InterruptedException {
		if (CloseBrowser) {
			...
			setReport("TC01_P0 Linesheet- Verify Merch Filters for Line Sheet");
		}
	}
	@Test(priority = 0, dataProvider = "TC01_P0_Linesheet_ValidateFilters_Merch", dataProviderClass = DataProviders.class)
	public void P0_TC_01_ValidateLinesheet_Merch_Filter(String TestType,String season,String filterValue,String expectedAttributes) 
					throws Exception{
		if (CloseBrowser) {
			test = extent.createTest(":::TC01_P0 Linesheet- Verify Merch Filters for Line Sheet :::");
		}
		CloseBrowser = false;
		...
		try {
			test.log(Status.INFO, "This tescase covers TC_105 to TC_108");
